...
namespace DogSheet
{
    ...
    {
        private readonly TableDataWindow TDW;
        private readonly TableWork TW;

        private readonly Excel.Workbook workbookFull;
        private readonly Excel.Worksheet worksheetFull;
        private readonly Excel.Range rng;

        private readonly string[] allData = new string[33];
        ...
        private void Doc1Checkbox_Checked(object sender, RoutedEventArgs e)
        {
            if (Doc1Checkbox.IsChecked == true)
            {
                RequestNumberTextbox.IsEnabled = true;
                RequestDateTextbox.IsEnabled = true;
                HeadTextbox.IsEnabled = true;
                CategoryCombobox.IsEnabled = true;
                FurCombobox.IsEnabled = true;
                EarsCombobox.IsEnabled = true;
                TailCombobox.IsEnabled = true;
                ChipTextbox.IsEnabled = true;
            }
            else
            {
                RequestNumberTextbox.IsEnabled = false;
                RequestDateTextbox.IsEnabled = false;
                HeadTextbox.IsEnabled = false;
                CategoryCombobox.IsEnabled = false;
                FurCombobox.IsEnabled = false;
                EarsCombobox.IsEnabled = false;
                TailCombobox.IsEnabled = false;
                ChipTextbox.IsEnabled = false;
            }
        }
        ...
        private void GroupCheckbox_Checked(object sender, RoutedEventArgs e)
        {
            ...
            {
                CatcherTextbox.IsEnabled = true;
            }
            else
            {
                CatcherTextbox.IsEnabled = false;
                CatcherTextbox.Text = HeadTextbox.Text;
            }
        }

        private void Doc2Checkbox_Checked(object sender, RoutedEventArgs e)
        {
            if (Doc2Checkbox.IsChecked == true)
            {
                MedicalTextbox.IsEnabled = true;
                StMethodTextbox.IsEnabled = true;
            }
            else
            {
                MedicalTextbox.IsEnabled = false;
                StMethodTextbox.IsEnabled = false;
            }
        }
    }
}
